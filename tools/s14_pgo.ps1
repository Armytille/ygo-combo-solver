...
#   * temoin nomme combosolver_lto_s14.exe (NE PAS ecraser les temoins s12/s13,
...
Copy-Item bin\Release\combosolver.exe bin\Release\combosolver_lto_s14.exe -Force
...
& .\bin\Release\combosolver.exe $ref `
    ...
    --outdir s14_pgo_train1 --no-chain Zalen --no-chain "Crystal Wing" `
    *> s14_pgo_train1.log
...
& .\bin\Release\combosolver.exe $ref `
    ...
    --outdir s14_pgo_train2 *> s14_pgo_train2.log
...
& .\bin\Release\combosolver.exe $ref `
    ...
    --solve-ms 30000 --seed $Seed `
    --no-chain Zalen --no-chain "Crystal Wing" `
    --outdir s14_pgo_train3 *> s14_pgo_train3.log
...
& .\bin\Release\combosolver.exe $ref `
    ...
    --resolve "PSY-Framelord Omega@terrain:2" `
    --resolve "Trishula, Dragon of the Ice Barrier@terrain" `
    --outdir s14_pgo_train4 *> s14_pgo_train4.log
...
& .\bin\Release\combosolver.exe $ref `
    ...
    --resolve "PSY-Framelord Omega@terrain:2" `
    --resolve "Trishula, Dragon of the Ice Barrier@terrain" `
    --outdir s14_pgo_train5 *> s14_pgo_train5.log
...
Write-Output "--- exe PGO lie (temoin : combosolver_lto_s14.exe)"
